...
// replaceFileSafely prefers the platform's same-directory rename-overwrite
// behavior. On platforms where replacing an existing destination via Rename
// is not supported (notably Windows), it falls back to a rollback-capable swap.
